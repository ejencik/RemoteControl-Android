...
public class GraphHumiFragment extends Fragment {
...
//	  inflater = i;
      ...
      cm = new ConnectionCredentialsManager(getActivity());
		    int sensor_id = getResources().getInteger(R.integer.sensor_ENV_humi);
...
//		dataRenderer.setPointStyle(PointStyle.CIRCLE);			//setting line graph point style to circle
		...
		LinearLayout chartContainer = v.findViewById(R.id.chart);
